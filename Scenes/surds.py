...
class RationalisingSurds(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(FadeOut(c_arrow_2_group[0]), Create(c_arrow_2_group[1]), Write(columns[0][2][1]))
        self.wait()
        self.play(FadeOut(c_arrow_2_group[1]), Create(c_arrow_2_group[2]), Write(columns[0][2][2]))
        self.wait()
        self.play(FadeOut(c_arrow_2_group[2]), Create(c_arrow_2_group[3]), Write(columns[0][2][3]))
        self.play(FadeOut(c_arrow_2_group[3]))
        self.wait()
